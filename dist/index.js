...
const hintoTipsAbi_1 = require("./utils/hintoTipsAbi");
...
class HintoSdk {
    constructor(providerUrl, contractAddress, privateKey) {
        ...
        if (privateKey) {
            ...
            this.contractInstance = new ethers_1.Contract(contractAddress, hintoTipsAbi_1.HintoTipsAbi, this.wallet);
            return;
        }
        this.contractInstance = new ethers_1.Contract(contractAddress, hintoTipsAbi_1.HintoTipsAbi, new ethers_1.providers.JsonRpcProvider(providerUrl));
    }
